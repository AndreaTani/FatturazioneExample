...
namespace FatturazioneExample.Data.Data
{
    ...
    {
        // Ogni volta che si fanno midifiche utilizzare quoesto testo tra ||  => | -- "datasource=D:\\DB_SQLite\\sqlite.db"|
        // come parametro finale alle "add migration" ed alle "database update"
        /*
            Ciclo di vita di una modifica
            -----------------------------
            1) Modifica del context
            2) dotnet ef migration add MIGRATION NAME -- "datasource=D:\\DB_SQLite\\sqlite.db"
